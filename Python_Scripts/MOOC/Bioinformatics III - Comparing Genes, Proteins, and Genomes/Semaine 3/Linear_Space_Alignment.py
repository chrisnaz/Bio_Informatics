...
from Middle_Edge_in_linear_Space_Problem import middle_edge
...
def main():
    ...
    with open('Data/Linear_Space_Alignment.txt') as input_data:
    ...
    with open('Data/Answer/Linear_Space_Alignment.txt', 'w') as output_data:
